...
Return<void> Stream::getSupportedSampleRates(AudioFormat format,
    ...
    if (result == Result::OK) {
        halSampleRates =
            samplingRatesFromString(halListValue.str(), AudioParameter::valueListSeparator);
...
Return<void> Stream::getSupportedChannelMasks(AudioFormat format,
    ...
    if (result == Result::OK) {
        halChannelMasks =
            channelMasksFromString(halListValue.str(), AudioParameter::valueListSeparator);
...
Return<void> Stream::getSupportedFormats(getSupportedFormats_cb _hidl_cb) {
    ...
    if (result == Result::OK) {
        halFormats = formatsFromString(halListValue.str(), AudioParameter::valueListSeparator);
